...
function Store(storeName, minCustomerEachHour,
  maxCustomerEachHour, averageCookiesPerCustomer) {
...
var seattle = new Store('seattle best cookie', '23', '65', '6.3');
var tokyo = new Store('tokyo best cookie', '3', '24', '1.2');
var Dubai = new Store('')
console.log(seattle);
console.log(tokyo);
...
// trEl.appendChild(tdEl);
// tdEl = document.createElement('td');
// tdEl.textContent = seattle.totalCookiesForTheDay + tokyo.totalCookiesForTheDay + Dubai.+ Lima.cookiesEachHour[0];
// trEl.appendChild(tdEl);
